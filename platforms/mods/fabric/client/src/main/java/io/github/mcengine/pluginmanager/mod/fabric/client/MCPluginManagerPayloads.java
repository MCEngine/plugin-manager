 ...
 * {@link io.github.mcengine.pluginmanager.mod.core.MCPluginManagerPayloadCodec}.
...
public final class MCPluginManagerPayloads {
    ...
    public record Request(byte[] data) implements CustomPayload {
        ...
        public static final CustomPayload.Id<Request> ID = new CustomPayload.Id<>(
            Identifier.of(MCPluginManagerChannel.NAMESPACE, MCPluginManagerChannel.REQUEST_PATH));
    ...
    public record Response(byte[] data) implements CustomPayload {
        ...
        public static final CustomPayload.Id<Response> ID = new CustomPayload.Id<>(
            Identifier.of(MCPluginManagerChannel.NAMESPACE, MCPluginManagerChannel.RESPONSE_PATH));
